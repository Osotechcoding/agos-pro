      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
        ...
        <tr>
          <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
            <img src="../../assets/img/agos-logo.jpg" alt=""
              style="width: 200px; max-width: 400px; height: auto; margin: auto; display: block;border-radius:20px">
          </td>
        </tr><!-- end tr -->
        <tr>
              ...
              <tr>
                <td>
                  <div class="text" style="padding: 0 2.5em; text-align: center;">
                    ...
                    <p>This link will expire at <?php echo $tokenExp; ?></p>
                  </div>
                </td>
              </tr>
            </table>
                    ...
                    <tr>
                      <td style="text-align: left; padding-left: 10px;">
                        ...
                        <ul>
                          ...
                          <li><a href="http://localhost/agos-pro/about">About</a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
