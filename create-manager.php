            ...
            <div class="col-md-12 col-sm-12">
              <div class="card card-box">
                ...
                <div class="card-body" id="bar-parent">
                  <form id="createNewStaffForm" class="form-horizontal">
                    <div class="form-body">
                      <div class="form-group row">
                        ...
                        <div class="col-md-5">
                          <input type="text" name="first_name" data-required="1" placeholder="enter first name"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-5">
                          <input type="text" name="last_name" data-required="1" placeholder="enter last name"
                            class="form-control input-height" />
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-5">
                          <select class="form-select input-height" name="city">
                            <option value="">Select...</option>
                      ...
                      <input type="hidden" name="action" value="register_new_staff_btn">
