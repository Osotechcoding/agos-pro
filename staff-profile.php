                ...
                <div class="card">
                  ...
                  <div class="card-body no-padding height-9">
                    <div class="profile-desc">
                      <?php echo $staff_data->address; ?>
                    </div>
                    <ul class="list-group list-group-unbordered">

                      <li class="list-group-item">
                        <b>Gender </b>
                        <div class="profile-desc-item pull-right"><?php echo $staff_data->gender; ?></div>
                      </li>
                      <li class="list-group-item">
                        <b>State </b>
                        <div class="profile-desc-item pull-right"><?php echo $staff_data->state_of_origin; ?> </div>
                      </li>
                      <li class="list-group-item">
                        <b>Account Status </b>
