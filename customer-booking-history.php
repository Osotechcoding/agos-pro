...
if (isset($_GET['cid']) && isset($_GET['action']) && !$Core->isEmptyStr($_GET['cid']) && $_GET['action'] === "view-history") {
...
<head>
  ...
  <title>AGOS Hotel - <?php echo ucwords($customer_details->fullname) ?></title>
  <!-- icons -->
                ...
                <div class="card-body ">
                  ...
                  <div class="table-scrollable">
                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                      ...
                      <tbody>
                        <?php
                        $recentBookings = $Room->getAllMyBookingHistoryById($cId);
                        if ($recentBookings) {
                          $cnt = 0;
                        ...
                        <tr class="odd gradeX">
                          ...
                          <td class="center"><a
                              href="customer-invoice?bookingId=<?php echo $recent->id; ?>&action=print-invoice&cid=<?php echo $cId; ?>"><button
